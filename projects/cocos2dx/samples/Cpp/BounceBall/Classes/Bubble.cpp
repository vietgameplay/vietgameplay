...
Bubble::Bubble( CCLayer* layer, CCSprite* sprite, int deadTime  ) : CommonObject( layer, sprite )
{
	this->deadTime = deadTime;
	//random jumpstep 
	this->jumpStepY = BASE_BUBBLE_JUMP_STEP + rand()%4 + s_currentScore/POINT_DECREASE_TIME;
