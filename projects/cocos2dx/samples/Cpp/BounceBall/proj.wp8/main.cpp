...
void Main::SetWindow(CoreWindow^ window)
{
    ...
    eglView->setViewName("Bubble Shoot");
}
...
{
	HardwareButtons::BackPressed += ref new EventHandler<BackPressedEventArgs^>(this, &Main::OnBackButtonPressed);   
	CoreWindow::GetForCurrentThread()->Activate();
}

void Main::OnBackButtonPressed(Object^ sender, BackPressedEventArgs^ args)
{
