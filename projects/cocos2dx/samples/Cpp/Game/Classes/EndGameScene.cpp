...
bool EndGameScene::init()
{
    ...
    CCMenuItemImage *pCloseItem = CCMenuItemImage::create(
                                        ...
                                        "CloseSelected.png",
                                        this,
                                        menu_selector(EndGameScene::menuCloseCallback));
...
bool EndGameScene::ccTouchBegan(cocos2d::CCTouch *pTouch, cocos2d::CCEvent *pEvent)
{
	count++;
...
void EndGameScene::registerWithTouchDispatcher()
{
